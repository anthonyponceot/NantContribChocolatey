...
$url        = 'https://freefr.dl.sourceforge.net/project/nantcontrib/nantcontrib/0.92/nantcontrib-0.92-bin.zip' # download url, HTTPS preferred
$packageArgs = @{
  ...
  softwareName  = 'nantContrib*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
